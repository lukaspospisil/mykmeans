...
if and(length(ns) > 1, length(Ts) > 1)
    ...
    hold on
    title('total time')
    plot_all_one(timess(:,:,5)'./timess(:,:,6)',ngrid,Tgrid,edgecolor, facecolor);
    ...
    hold on
    title('L computation')
    plot_all_one(timess_L(:,:,5)'./timess_L(:,:,6)',ngrid,Tgrid,edgecolor, facecolor);
    zlabel('speed up','Interpreter','latex')
    hold off
    ...
    hold on
    title('Gamma all')
    plot_all_one(timess_Gamma.all(:,:,5)'./timess_Gamma.all(:,:,6)',ngrid,Tgrid,edgecolor, facecolor);
    zlabel('speed up','Interpreter','latex')
    hold off
    ...
    plot_all_one(timess_Gamma.assemble(:,:,5)'./timess_Gamma.assemble(:,:,6)',ngrid,Tgrid,edgecolor, facecolor);
    zlabel('speed up','Interpreter','latex')
    hold off
    ...
    hold on
    title('Gamma solve')
    plot_all_one(timess_Gamma.solve(:,:,5)'./timess_Gamma.solve(:,:,6)',ngrid,Tgrid,edgecolor, facecolor);
    zlabel('speed up','Interpreter','latex')
    hold off
    ...
    hold on
    title('S all')
    plot_all_one(timess_S.all(:,:,5)'./timess_S.all(:,:,6)',ngrid,Tgrid,edgecolor, facecolor);
    zlabel('speed up','Interpreter','latex')
    hold off
    ...
    hold on
    title('S assemble')
    plot_all_one(timess_S.assemble(:,:,5)'./timess_S.assemble(:,:,6)',ngrid,Tgrid,edgecolor, facecolor);
    zlabel('speed up','Interpreter','latex')
    hold off
    ...
    hold on
    title('S solve')
    plot_all_one(timess_S.solve(:,:,5)'./timess_S.solve(:,:,6)',ngrid,Tgrid,edgecolor, facecolor);
    zlabel('speed up','Interpreter','latex')
    hold off
